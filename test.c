...
//void e3();	// ┘ 마지막줄 닫기
//
//void pan();	// f1 + f2 + f3 + middle + e1 + e2 + e3 (= 바둑판 출력)
//
//int result_black();	// 흑돌 승리 여부 판별
//int result_white();	// 백돌 승리 여부 판별
//
//void gotoxy();	// 커서 위치 조정 함수
//void key_move(int sw);	// 키보드로 바둑돌 조작
//
//int main()
//{
//	while (1)
...
//
//		if (result_black() == 0) break;	//흑돌 승리여부 판별
//
//		//백돌 시작
//		pan();							// 바둑판 출력
//
...
//
//		if (result_white() == 0) break;	//백돌 승리여부 판별
//	}
